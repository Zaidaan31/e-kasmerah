<?php include 'includes/PROapSH.php'; ?>
...
<head>
    ...
    <link href="assets/css/approval/approvalSH.css" rel="stylesheet" />
...
<body id="body">
    <div class="header">
        ...
        <h1 class="title-form">APPROVAL HEAD SECTION</h1>
    </div>
    <div class="card">
        <div class="nav-buttons-container">
            <div class="nav-buttons">
                ...
                <button onclick="showPage(2)" id="btn-2" class="nav-btn"><span style="font-size: 15px;">Approved <br>(
                    ...
                    <table id="myTable1" class="display nowrap" style="width:100%">
                        ...
                        <tbody>
                            ...
                            $query = "SELECT approval.*, vendor.no_vendor, vendor.nama as vendor, users.dept as dept ,users.username as user
                             ...
                             LEFT JOIN users ON approval.id_user = users.id WHERE status = 'head section'
                             AND users.dept = '$dept'";
                            ...
                            $query .= " ORDER BY approval.date DESC";
                            ...
                            ?>
                                <tr class="clickable-row1 text-muted  " style="font-size: 14px;" data-id="<?php echo $row['id']; ?>">
                    ...
                    <table id="myTable2" class="display nowrap" style="width:100%">
                        ...
                        <tbody>
                            ...
                            $query2 = "SELECT approval.*, vendor.no_vendor, vendor.nama as vendor, users.dept as dept ,users.username as user
                                ...
                                WHERE (status = 'success' OR status = 'cost control') 
                                AND users.dept = '$dept'";
    ...
    <script src="assets/js/approvalSH.js"></script>
