<?php include "includes/PROfviewsuccess_user.php" ?>
                ...
                <div class="table-wrapper" style="margin-top: 15px;margin-bottom:20px">
                    ...
                    <table id="barangTable" style="margin-top: 10px;">
                        <thead>
                            <tr>
                                <th style="">No</th>
                                <th style="width: 20rem;">Keterangan</th>
                                <th style="width:  25rem">Deskripsi</th>
                                <th style="width:  25rem">COA</th>
                                <th style="width:  25rem">ketCOA</th>
                                <th style="width:  39rem">Jumlah</th>
                                <th style="width:8rem">Bukti</th> <!-- Increased width -->
                                <th style=";">Status</th>
                    ...
                    while ($buktiRow = $buktiResult->fetch_assoc()):
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div id="upload-wrapper-<?php echo $rowId; ?>" class="upload-wrapper" style="width: 20rem;">
                                    <div class="upload-section">
                                        <div class="upload-content">
                                            <div>
                                                <!-- Icon for file if no file is present -->
                                                ...
                                                <!-- Image preview if file is present -->
                                                <img id="preview-bukti-detail-<?php echo $rowId; ?>" class="image-preview"
                    ...
                    while ($tolRow = $tolResult->fetch_assoc()):
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="input-container">
                                    <span class="currency-label">Rp.</span>
                                    <input type="number" name="tarif[]" class="form-control" oninput="updateRowTotalTol(this)"
                                        step="any" value="<?php echo $tolRow['biaya'] ?>" disabled>
                                </div>
                            </td>
                            <td>
                                <?php
                                ...
                                <div id="upload-wrapper-tol-<?php echo $rowIdTol; ?>" class="upload-wrapper"
                                    ...
                                    <div class="upload-section">
                                        <div class="upload-content">
                                            <div>
                                                <!-- Icon for file if no file is present -->
                                                <i class="fa-regular fa-file upload-icon" id="icon-tol-<?php echo $rowIdTol; ?>"
                                        ...
                                        <!-- File input -->
                                        <input type="file" id="upload-tol-<?php echo $rowIdTol; ?>" name="buktitol[]" disabled
