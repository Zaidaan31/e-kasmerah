<?php include "includes/PROviewCC.php" ?>
...
<body id="body">
                ...
                <div class="table-wrapper">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <?php else: ?>
                                                ...
                                                <div class="category-group">
                                                    <form id="form_lov_revisi" method="POST">
                                                        <input type="hidden" name="action" value="lov">
                                                        <input type="hidden" name="id_lov" value="<?php echo $row['id']; ?>">
                            ...
                            <tbody>
                                ...
                                while ($lovRow = $lovResult->fetch_assoc()):
                                    ...
                                    while ($buktiRow = $buktiResult->fetch_assoc()):
                                        ...
                                        <?php if ($buktiRow['status'] === 'success'): ?>
                                                <span class="badge badge-success">SUCCESS</span>
                    ...
                    <div style="text-align: center; margin-top: 30px;">
                        <form id="form_approval" method="POST">
                            ...
                            <button type="button" id="approveBtn" class="btn btn-success" style="border-radius: 30px; padding: 10px 20px; font-size: 16px; margin: 0 10px; width: 15rem; font-weight:600">Approve</button>
                            <button type="button" id="revisiBtn" class="btn btn-warning" style="border-radius: 30px; padding: 10px 20px; font-size: 16px; margin: 0 10px; width: 15rem; font-weight:600">Revisi</button>
                        </form>
                    ...
                    <div class="form-row" style="margin: 20px 0 50px 2px;">
                        <div class="category-group">
                            ...
                            <div class="input-textbox">
                                <textarea name="catatan" rows="4" class="text-area"
    ...
    <div id="imageModal" class="modal">
        <span class="close" onclick="closeModal()">&times;</span>
        <img class="modal-content" id="modalImage" alt="No Image Found">
        <div id="modalCaption"></div>
    </div>



    <script src="assets/js/fviewCC.js"></script>
