<?php include 'includes/PROdataVendor.php'; ?>
...
<body id="body">
    <div class="header">
        ...
        <h1 class="title-form">Data Vendor</h1>
    </div>
    <div class="card">
        <div class="card2">
                    ...
                    <tbody>
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            while ($row = $result->fetch_assoc()) {
                                echo "<tr>";
                                echo "<td>" . $no++ . "</td>";
                                echo "<td>" . $row['no_vendor'] . "</td>";
                                echo "<td>" . $row['nama'] . "</td>";
                                echo "<td>
                                    <a href='formeditVendor.php?id=" . htmlspecialchars($row['id']) . "' class='btn btn-warning'>
                            ...
                            echo "<tr><td colspan='5'>No Vendor found</td></tr>";
                        }
                        ?>
                    </tbody>
                </table>
                <a href="fvendor.php" style="margin-bottom: 10px;" class="btn btn-outline-danger rounded-circle">
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '.delete-btn', function() {
                ...
                if (confirm("Apakah Anda yakin ingin menghapus Vendor ini?")) {
                    $.ajax({
                        type: 'POST',
                        url: 'dataVendor.php', // Pastikan ini adalah file yang benar
                        data: {
                            id: userID
                        },
                        success: function(response) {
                            ...
                            if (response.trim() === 'success') {
                                ...
                                alert("Gagal menghapus Vendor: " + response);
                            }
                        },
