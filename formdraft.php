...
// session_start();
?>
<?php include "includes/PROformdraft.php" ?>
...
<div class="header">
    ...
    <div class="card">
        <form id="myForm" action="includes/PROformdraft1.php" method="post" enctype="multipart/form-data">
            <div class="card2">
                <div class="form-row">
                    <div class="form-group">
                        <label for="departemen">Departemen:</label>
                        <input type="text" name="id_approval" value="<?php echo $_GET['id']; ?>">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" name="invoice" value="<?php echo $data['invoice'] ?>" readonly>
                    </div>
                    <div class="form-group">
                        ...
                        <div style="display: flex; gap: 10px;">
                            ...
                            <input type="text" id="startPeriode" name="periodeAwal" placeholder="Start Date"
                                value="<?php echo $data['periodeAwal'] ?>" readonly>
                            <input type="text" id="endPeriode" name="periodeAkhir" placeholder="End Date"
                                value="<?php echo $data['periodeAkhir'] ?>" readonly>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" id="tanggalPengajuan" name="tanggalPengajuan"
                            value="<?php echo $data['tanggalPengajuan'] ?>" placeholder="Tanggal Pengajuan" readonly>
                    </div>
                    <div class="form-group">
                        <?php
                ...
                <div class="form-row">
                                ...
                                <tr class="total-row">
                                    ...
                                    <td colspan="1">
                                        ...
                                        <span id="grandTotal" class="currency">Rp.
                                            <?php echo htmlspecialchars(number_format($data['jumlahtotal'], 2), ENT_QUOTES, 'UTF-8'); ?>
                                        </span>
                                    ...
                                    <td colspan="2">
                                        <div class="total-words">
                                            ...
                                            <span id="grandTotalWords" class="currency">
                        ...
                        <table style="margin-top: 10px;">
                            ...
                            <tfoot>
                                <tr class="total-row">
                                    ...
                                    <td colspan="3"><span id="grandTotalbukti"
                                            class="currency">Rp.
                                        </span>
                    ...
                    <div id="tolTable" class="table-wrapper" style="margin-top: 15px;display:none">
                        ...
                        <table style="margin-top: 10px;">
                            ...
                            <tbody>
                                ...
                                while ($lovRow = $lovResult->fetch_assoc()):
                                    ...
                                    $tolQuery = "SELECT * FROM bukti WHERE id_lov = ?";
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select name="gerbangTol[]" style="width:200px" class="select-box">
                                                    <option value="#" placeholder="Select">Pilih Gerbang</option>
                                                    <?php
                                                    $queryg = mysqli_query($config, "SELECT id, nama_gerbang, tarif FROM tol");
                                                    while ($datag = mysqli_fetch_array($queryg)) {
                                                        echo "<option value=\"$datag[id]\" data-tarif=\"{$datag['tarif']}\">$datag[nama_gerbang]</option>";
                                                    } ?>
                                                </select>
                                            </td>
                                            <td>
                        ...
                        <div class="btn-group">
                            <button type="button" class="btnt" onclick="addRowTol()"><i
                                    class="fas fa-plus"></i></button>
                            <button type="button" class="btnt btnt-reset" onclick="resetTableTol()"><i
                                    class="fas fa-sync-alt"></i></button>
                        </div>
                    </div>
                    ...
                    <small style="font-size: 11px; color: #666;">
                        <div
                            style="background-color: #e9ecef; padding: 10px; border-radius: 8px; border: 1px solid #ccc;">
                            <strong style="display: block; margin-bottom: 5px;">Catatan Pengisian List Of
                                Value:</strong>
                            <ul style="margin: 0; padding-left: 20px; list-style-type: disc;">
                                <li><strong>Keterangan:</strong> Pilih kategori biaya pengajuan dari yang sudah di
                                    sediakan.
                                    Jika jenis biaya tidak tersedia dalam daftar seperti PPN, PPh, atau biaya lain,
                                    pilih
                                    opsi "Lainnya" dan jelaskan rincian tersebut di kolom deskripsi.</li>
                                <li><strong>Deskripsi:</strong> Berikan deskripsi singkat mengenai biaya yang diajukan.
                                    Jika
                                    Anda memilih "Lainnya" pada jenis biaya, pastikan untuk menyebutkan jenis biaya
                                    spesifik
                                ...
                                <li><strong>Bukti:</strong> Unggah file yang berfungsi sebagai bukti transaksi atau
                                    dokumen
                                    pendukung. Jenis file yang diperbolehkan meliputi JPG, PNG, PDF, DOC, dan EXCEL.
                                    Pastikan file yang diunggah jelas dan sesuai dengan format yang telah ditentukan.
                                </li>
                            </ul>
                        </div>
                    </small>
                    <div class="btn-s">
                        <button id="submitTolForm" type="submit" class="btn-style">Submit</button>
                    </div>
                </div>
        </form>
    </div>
...
<script src="assets/js/formdraft.js"></script>
...
<script>
    ...
    // Function to update the button visibility based on selected value
