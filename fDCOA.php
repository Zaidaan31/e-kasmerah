<?php include 'includes/PROfnewCOA.php'; ?>
        ...
        <div class="card2">
            <div class="card-body">
                <?php if (isset($_SESSION['flash_message'])): ?>
                    ...
                    ?>
                <?php endif; ?>
                <form action="includes/PROfDCOA.php" method="post">
                    <div class="form-group">
                        <label for="username">COA:</label>
                        <input type="text" id="COA" name="COA" class="form-control" placeholder="COA" required>
                    </div>
                    <div class="form-group">
                        <label for="email">KetCOA:</label>
                        <input type="text" id="KETCOA" name="KETCOA" class="form-control" placeholder="KETCOA" required>
                    </div>
                    <div class="form-group ">
